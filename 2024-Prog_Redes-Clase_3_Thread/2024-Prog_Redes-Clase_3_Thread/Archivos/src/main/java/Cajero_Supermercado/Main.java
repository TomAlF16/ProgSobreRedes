...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Esta clase heredaba de de Thread, asi que es un hilo y tiene actividades para hacer
		CajaHilo caja1 = new CajaHilo();
		caja1.start();
		// esta clase implementa Runnable asi que solo es una tarea a realizara
		Seguridad tareasdeguardia1= new Seguridad();
		Thread guardia1 = new Thread(tareasdeguardia1);
		guardia1.start();
		...
		empleado.setName("");
		empleado.setPriority(Thread.MAX_PRIORITY);
		empleado.start();
